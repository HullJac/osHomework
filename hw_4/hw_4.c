...
void run_matrix_test(int threadFlag) {
    ...
    int m10[] = {5,7,9,4,2,3,3,8,8,4,2,3,3,3,4,8};
    int m11[] = {3,5,6,9,2,1,4,9,9,3,4,2,3,7,4,8};
    int m12[] = {122,87,110,158,63,78,68,115,59,71,84,136,75,86,78,126};
    test_matrix_mult(m10, 4, 4, m11, 4, 4, m12, threadFlag);
...
int main(int argc, char** argv) {
    ...
    float r = dine_philosophers_dine(25, 50);
    printf("Attempts to eating ratio: %.2f\n", r);
